...
sub g_slist_copy_deep (GSList $list, GCopyFunc $func, gpointer $user_data)
  returns GSList
  is native(lib)
  is export
  { * }
...
sub g_slist_find_custom (GSList $list, gpointer $data, GCompareFunc $func)
  returns GSList
  is native(lib)
  is export
  { * }
...
sub g_slist_insert_before (GSList $slist, GSList $sibling, gpointer $data)
  returns GSList
  is native(lib)
  is export
  { * }

sub g_slist_insert_sorted (GSList $list, gpointer $data, GCompareFunc $func)
  returns GSList
  is native(lib)
  is export
  { * }
