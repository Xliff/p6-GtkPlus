...
class GTK::Compat::Window {
  ...
  method create-surface {
    self.connect($!window, 'create-surface');
  }

  # Is originally:
  # GdkWindow, gdouble, gdouble, gpointer, gpointer, gpointer --> void
  method from-embedder {
    self.connect($!window, 'from-embedder');
  }

  # Is originally:
  # GdkWindow, gpointer, gpointer, gboolean, gboolean, gpointer --> void
  method moved-to-rect {
    self.connect($!window, 'moved-to-rect');
  }

  # Is originally:
  # GdkWindow, gdouble, gdouble, gpointer --> GdkWindow
  method pick-embedded-child {
    self.connect($!window, 'pick-embedded-child');
  }

  # Is originally:
  # GdkWindow, gdouble, gdouble, gpointer, gpointer, gpointer --> void
  method to-embedder {
    self.connect($!window, 'to-embedder');
  }
  ...
  method background_pattern is rw {
    Proxy.new(
      FETCH => sub ($) {
  ...
  method gdk_offscreen_window_embedder is rw {
    Proxy.new(
      FETCH => sub ($) {
  ...
  method event_compression is rw {
    Proxy.new(
      FETCH => sub ($) {
  ...
  method begin_draw_frame (cairo_region_t $region) {
  ...
  method create_gl_context (CArray[Pointer[GError]] $error = gerror) {
  ...
  method get_device_cursor (GdkDevice $device) {
  ...
  method get_drag_protocol (GdkWindow $target) {
    gdk_window_get_drag_protocol($!window, $target);
  }

  method get_effective_parent {
    gdk_window_get_effective_parent($!window);
  }

  method get_effective_toplevel {
  ...
  method get_frame_extents (GdkRectangle $rect) {
  ...
  method get_origin (gint $x, gint $y) {
  ...
  method get_position (gint $x, gint $y) {
  ...
  method get_root_origin (gint $x, gint $y) {
  ...
  method get_user_data (gpointer $data) {
  ...
  method mark_paint_from_clip (cairo_t $cr) {
  ...
  method merge_child_input_shapes {
  ...
  method set_background (GdkColor $color) {
    gdk_window_set_background($!window, $color);
  }

  method set_background_rgba (GdkRGBA $rgba) {
    gdk_window_set_background_rgba($!window, $rgba);
  }

  method set_child_input_shapes {
  ...
  method set_functions (GdkWMFunction $functions) {
  ...
  method set_icon_list (GList $pixbufs) {
    gdk_window_set_icon_list($!window, $pixbufs);
  }

  method set_icon_name (gchar $name) {
  ...
  method set_title (gchar $title) {
    gdk_window_set_title($!window, $title);
  }

  method set_transient_for (GdkWindow $parent) {
    gdk_window_set_transient_for($!window, $parent);
  }

  method set_urgency_hint (gboolean $urgent) {
    gdk_window_set_urgency_hint($!window, $urgent);
  }

  method set_user_data (gpointer $user_data) {
